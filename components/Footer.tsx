...
const Footer: React.FC = () => {
  return (
    <footer className="mx-auto max-w-6xl px-5 md:px-0 pt-5 sm:pt-8 md:pt-10 lg:pt-12 bg-gray-100 dark:bg-darkBg border-gray-200 dark:border-gray-600 border-t-2">
      <div>
