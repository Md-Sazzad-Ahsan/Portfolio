...
const Cards: React.FC<CardProps> = ({ icon: Icon, title, subtitle, description }) => {
  return (
    <li className="h-80 flex flex-col p-5 sm:p-6 ring-white shadow-xl hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md">
      ...
      <div className="text-2xl text-cyan-600 dark:text-cyan-700 font-bold pb-2 md:pb-3 pl-10 sm:pl-4">
        {title}
      </div>
      <div className="text-sm sm:text-md text-gray-700 dark:text-gray-50 pl-10 sm:pl-4 overflow-hidden">
        {subtitle}
        <br />
