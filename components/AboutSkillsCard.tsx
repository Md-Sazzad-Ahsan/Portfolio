...
<section>
  <article className="bg-gray-50 dark:bg-darkBg grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-1 sm:gap-2 mt-20 md:mt-24 pb-10">
    <div className="text-3xl text-cyan-600 dark:text-gray-50 font-bold text-center p-5 sm:p-0 col-span-full uppercase py-5 md:pt-10 md:pb-5">Experienced in</div>
    <Cards
        icon={BsPencilSquare}
      ...
      />
    <div className="col-span-full text-center pt-5 sm:pt-8 md:pt-10"><a href="#" className="bg-cyan-700 px-8 py-1 text-base sm:text-md md:text-lg text-gray-50 font-semibold rounded-md shadow-md hover:shadow-lg hover:bg-cyan-900">View all</a></div>
  </article>
</section>
</main>
  )
