...
import { LatestBlogData } from "@/components/BlogComponent/LatestBlog/LatestBlogData";
import Link from "next/link";

const LatestBlogGrid: React.FC = () => {
  const mainBlog = LatestBlogData[0];
  const secondaryBlogs = LatestBlogData.slice(1);
