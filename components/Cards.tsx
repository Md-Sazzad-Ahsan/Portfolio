...
const Card: React.FC<CardProps> = ({ icon: Icon, title, subtitle, description }) => {
  return (
    <li className="h-80 flex flex-col p-5 sm:p-6 md:p-8 ring-white shadow-xl hover:bg-gray-700 rounded-md">
