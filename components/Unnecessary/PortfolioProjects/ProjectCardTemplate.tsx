...
const ProjectCardTemplate: React.FC<ProjectCardTemplateProps> = ({ imageSrc, category, headline, description, link }) => {
  return (
    <li className="bg-gray-50 dark:bg-darkBg flex flex-col p-2 m-2 sm:m-0 ring-white shadow-xl hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md h-[28rem] w-full"> {/* Set a fixed height */}
