...
const SelectedWork = () => {
  return (
    <section className="w-full px-6 md:px-16 py-20 bg-white dark:bg-darkBg">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="w-full md:w-1/2 space-y-4">
            <p className="uppercase text-sm text-gray-500 dark:text-gray-400 font-semibold text-center sm:text-start">
              Most Recent
            </p>
            ...
            <p className="text-base text-gray-600 dark:text-gray-300">
              <strong>An innovative virtual platform</strong> enhancing online
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <span className="bg-transparent text-purple-800 text-xs md:text-md font-medium px-3 py-1 rounded-full">
                AI assistant
              </span>
              <span className="bg-transparent text-blue-800 text-xs md:text-md font-medium px-3 py-1 rounded-full">
                Live translation
              </span>
              <span className="bg-transparent text-pink-800 text-xs md:text-md font-medium px-3 py-1 rounded-full">
                Whiteboard
              </span>
              <span className="bg-transparent text-pink-800 text-xs md:text-md font-medium px-3 py-1 rounded-full">
                Collab tool
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4 w-full">
              <a
                href="https://your-live-preview-link.com"
                target="_blank"
