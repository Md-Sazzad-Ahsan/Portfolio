...
export default function Home() {
  ...
  return (
    <main className=" flex flex-col">
      <section className="flex flex-col sm:flex-row justify-between gap-20 sm:gap-5 px-5 sm:px-16 md:px-48 lg:px-56 py-28 sm:py-36 md:py-40 items-left text-left sm:text-left">
