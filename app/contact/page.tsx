...
export default function Contact()
{
    return (
        ...
        <SeparatePages dividerText="Contact_" dividerTextColor="text-cyan-600" subText="Programming | ICT | GK | Story" className={`px-5 sm:px-16 md:px-48 lg:px-56 py-10 sm:py-20 md:py-28 text-center sm:text-start ${playfair.className}`} />
        <ContactForm />
        <MapImage />
        <UnderConstruction />
        </main>
